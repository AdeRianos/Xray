...
<div id="conRegistration" class="center shadow1">
    ...
    <div class="container ">
        ...
        <form id="formRegistr" name="formRegistr" class="container" method="post" onsubmit="return valDatForReg()" action="check.php" >
            ...
            <div class="container pading10">
                <div class="col-6">
                    <input  type="submit" name="Registration" id="index2.html" value="ثبت نام">
                </div>
                <div class="col-6">
                    <input type="reset" name="nameUser" id="index2.html" value="انصراف">
